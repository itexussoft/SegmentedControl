...
open class TwicketSegmentedControl: UIControl {
    ...
    open var defaultTextColor: UIColor = UIColor(white: 1, alpha: 0.76) {
        didSet {
    ...
    open var segmentsBackgroundColor: UIColor = #colorLiteral(red: 0.6392156863, green: 0.5215686275, blue: 0.9568627451, alpha: 1) {
        didSet {
            backgroundView.backgroundColor = segmentsBackgroundColor
        }
    }

    open var sliderBackgroundColor: UIColor = #colorLiteral(red: 0.6392156863, green: 0.5215686275, blue: 0.9568627451, alpha: 1) {
        didSet {
    ...
    private func setup() {
        ...
        selectedContainerView.clipsToBounds = true
